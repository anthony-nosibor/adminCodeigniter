            ...
            <div class="container">
                <div id="login-page" class="row">
                    <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
                        <form method="post" action="<?= base_url('/login/connexion'); ?>" class="login-form">
                            <div class="row">
                                <div class="input-field col s12">
                                    <h5 class="ml-4">Identifiez-vous</h5>
          												                      </div>
                            </div>
                            <div class="row margin">
                                <div class="input-field col s12">
                                    ...
                                    <label for="username" class="center-align">Saisissez votre Pseudo</label>
                                </div>
                            </div>
                            <div class="row margin">
                                <div class="input-field col s12">
